...
class mypipelineSAG(DiffusionPipeline):
    ...
    def __init__(
        ...
        self.img_iter = 0
        self.debug_folder = r"D:\Analysis\BrainDiVE-main\Figures\6.20\Debug"
    ...
    def __call__(
        ...
        self.img_iter += 1
        noise_trace_folder = os.path.join(self.debug_folder, f"{self.img_iter:03d}")
        os.makedirs(noise_trace_folder, exist_ok=True)
        ...
        for i, t in enumerate(timesteps):
            ...
            if self.debug_folder is not None:
                ...
                with torch.no_grad():
                    debug_decoded = self.decode_latents(latents)
                    image = self.numpy_to_pil(debug_decoded)
                    image[0].save(f"{noise_trace_folder}\step_{i:03d}.png")
